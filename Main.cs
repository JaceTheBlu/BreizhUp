...
using BreizhUp.Ingredients.Items.Kouign_Amann;
using BreizhUp.Ingredients.Items.Butter;
using System.Linq;
using System.IO;
...
namespace BreizhUp
{
    public class Main : BaseMod, IModSystem
    {
        ...
        // Kouign Amann
        internal static Item KouignAmann => (Item)GDOUtils.GetCustomGameDataObject<KouignAmann>().GameDataObject;
        internal static Item KouignAmannBurnt => (Item)GDOUtils.GetCustomGameDataObject<KouignAmannBurnt>().GameDataObject;
        internal static Item KouignAmannRaw => (Item)GDOUtils.GetCustomGameDataObject<KouignAmannRaw>().GameDataObject;
        internal static ItemGroup KouignAmannUnprepared => (ItemGroup)GDOUtils.GetCustomGameDataObject<KouignAmannUnprepared>().GameDataObject;
        ...
        protected override void OnPostActivate(KitchenMods.Mod mod)
        {
            ...
            // Dishes
            // Desserts
            AddGameDataObject<KouignAmann>();
            AddGameDataObject<KouignAmannBurnt>();
            AddGameDataObject<KouignAmannRaw>();
            AddGameDataObject<KouignAmannUnprepared>();
        }
    }
}
